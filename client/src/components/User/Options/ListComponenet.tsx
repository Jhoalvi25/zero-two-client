  ...
  return (
    <div  className={style['div-lists-secondary']}>
      <div className={style['div-lists-secondary_div1']}>
        ...
        <span className={style['div-lists-secondary_div1_span']}>{props.animes} elementos añadidos</span>
      </div>
      {
        showOptions && props.name !== 'Favorites' ? (
          <div className={style['div-lists-secondary_div2']}>
            <FontAwesomeIcon onClick={toggleMenu} icon={faEllipsisVertical} className={style['icon-elipsis']} />
          <div className={
          ...
          </div> 
          {
            modalEdit && (
              <div className={style['modal']}>
                ...
                <div className={style['modal-content']}>
                  ...
                  <div className={style['form-nicolas']}>
                    <input className={style['form-input']} onChange={e => changeEditNameHandler(e, props.id)} type="text" name="name" value={listEdit.name} placeholder="Type the new name of the list"></input>
              ...
              <div onClick={() => deleteHandler(props.id)} className={style['list-span-delete']}>
